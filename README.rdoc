...
This fork of the gem is distributed via http://rubygems.org/gems/mbautin-rottentomatoes and
has some improvements that the original version does not (e.g. fixed bugs, fixed RSpec tests,
more complete set of movie types).
